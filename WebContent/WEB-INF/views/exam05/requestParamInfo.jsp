   ...
   <div class="card-body">
      ...
      <form method="post" action="ParamController" novalidate>
         ...
         <div class="form-group">
			...
			<button type="submit" class="btn btn-primary btn-sm">POST방식으로 전달</button>
      </form>
		...
		<form method="post" enctype="multipart/form-data" action="FileUploadController" >
			<div class="form-group">
	         ...
	         <div class="form-group">
	            ...
	            <input type="desc" class="form-control" placeholder="Desc" id="desc" name="desc">
	         </div>
			<div class="form-group">
				<label for="attach">Attach</label> 
				<input type="file" class="form-control-file" id="attach1" name="attach1">
				<input type="file" class="form-control-file" id="attach2" name="attach2">
				<input type="file" class="form-control-file" id="attach3" name="attach3">
			</div>
